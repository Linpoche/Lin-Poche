...
function throwinmodal_orders_detail(myid) {
    ...
    document.getElementById('pid_e').value = throw_ProductID;
    ...
    document.getElementById('Quan_e').value = throw_Quantity;
    document.getElementById('Dis_e').value = throw_Discount;
